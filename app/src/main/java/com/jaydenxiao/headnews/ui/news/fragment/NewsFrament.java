package com.jaydenxiao.headnews.ui.news.fragment;
...
import com.jaydenxiao.headnews.bean.NewsSummary;
import com.jaydenxiao.headnews.ui.news.adapter.NewListAdapter;
import com.jaydenxiao.headnews.ui.news.contract.NewsListContract;
import com.jaydenxiao.headnews.ui.news.model.NewsListModel;
import com.jaydenxiao.headnews.ui.news.presenter.NewsListPresenter;
...
public class NewsFrament extends BaseFragment<NewsListPresenter, NewsListModel> implements NewsListContract.View, OnRefreshListener, OnLoadMoreListener {
    ...
    public void onRefresh() {
        ...
        Log.i("参数", "------->" + mNewsType + "," + mNewsId + "," + mStartPage);
        mPresenter.getNewsListDataRequest(mNewsType, mNewsId, mStartPage);
    }
